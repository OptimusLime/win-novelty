...
function NoveltyArchive(logger, config)
{
    ...
    var shouldEnterArchive = config.shouldEnterArchive || self.shouldEnterArchive;

    var preArchiveAdditions = config.preArchiveAdditions || self.preArchiveAdditions;
    var postArchiveAdditions = config.postArchiveAdditions || self.postArchiveAdditions;
    ...
    self.shouldEnterArchive = function(wid, artifactEval, archive)
    {
        ...
        for(var wid in archive)
        {
            ...
            var dist = distance(artifactEval.behaviors, archive.behaviors);
    ...
    self.preArchiveAdditions = function(pending)
    {
        var lenght = Object.keys(pending).length;
    ...
    //meh.
    self.postArchiveAdditions = function(added)
    {
    }
